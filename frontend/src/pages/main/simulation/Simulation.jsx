...
import { DollarSign, TrendingUp, TrendingDown, Search, HelpCircle } from 'lucide-react';
...
const QUIZ_QUESTIONS = [
  {
    ...
    options: ["Price to Earnings", "Profit and Expense", "Percentage Equity", "Public Estimation"],
    correct: 0
  },
  {
  ...
  },
  {
    ...
    options: ["A market with falling prices", "A market with rising prices", "A market with no change", "A market for cattle"],
    correct: 1
  },
  {
    question: "What is a bear market?",
    options: ["A market with falling prices", "A market with rising prices", "A market with no change", "A market for bears"],
    correct: 0
  },
  {
    question: "What is an IPO?",
    options: ["Initial Public Offering", "International Purchase Order", "Internal Price Offering", "Initial Price Order"],
    correct: 0
  },
  {
    question: "What does ETF stand for?",
    options: ["Exchange Traded Fund", "Equity Traded Fund", "Exchange Transfer Fund", "Equity Transfer Fund"],
    correct: 0
  },
  {
    question: "What is a dividend?",
    options: ["A portion of a company's earnings distributed to shareholders", "A type of bond", "A stock market index", "A financial statement"],
    correct: 0
  },
  {
    question: "What is market capitalization?",
    options: ["The total value of a company's outstanding shares", "The total revenue of a company", "The total profit of a company", "The total assets of a company"],
    correct: 0
  },
  {
    question: "What is a stock split?",
    options: ["An increase in the number of shares outstanding", "A decrease in the number of shares outstanding", "A type of dividend", "A type of bond"],
    correct: 0
  },
  {
    question: "What is a blue-chip stock?",
    options: ["A stock of a large, well-established, and financially sound company", "A stock of a small company", "A stock of a new company", "A stock of a technology company"],
    correct: 0
  },
  {
    question: "What is a mutual fund?",
    options: ["An investment vehicle that pools money from many investors to purchase securities", "A type of bond", "A type of stock", "A financial statement"],
    correct: 0
  },
  {
    question: "What is a bond?",
    options: ["A fixed income instrument that represents a loan made by an investor to a borrower", "A type of stock", "A financial statement", "A type of mutual fund"],
    correct: 0
  },
  {
    question: "What is a stock market index?",
    options: ["A measurement of the performance of a section of the stock market", "A type of stock", "A type of bond", "A financial statement"],
    correct: 0
  },
  {
    question: "What is a portfolio?",
    options: ["A collection of investments held by an individual or institution", "A type of stock", "A type of bond", "A financial statement"],
    correct: 0
  },
  {
    question: "What is diversification?",
    options: ["A risk management strategy that mixes a wide variety of investments within a portfolio", "A type of stock", "A type of bond", "A financial statement"],
    correct: 0
  },
  {
    question: "What is a hedge fund?",
    options: ["An alternative investment vehicle that uses pooled funds to earn active returns for investors", "A type of stock", "A type of bond", "A financial statement"],
    correct: 0
  },
  {
    question: "What is a margin account?",
    options: ["A brokerage account in which the broker lends the customer cash to purchase securities", "A type of stock", "A type of bond", "A financial statement"],
    correct: 0
  },
  {
    question: "What is short selling?",
    options: ["The sale of a security that the seller has borrowed", "The purchase of a security", "A type of bond", "A financial statement"],
    correct: 0
  },
  {
    question: "What is a stock buyback?",
    options: ["A company's repurchase of its own shares", "A type of bond", "A financial statement", "A type of mutual fund"],
    correct: 0
  },
  {
    question: "What is a stock option?",
    options: ["A financial derivative that gives the buyer the right to buy or sell a stock at an agreed-upon price and date", "A type of bond", "A financial statement", "A type of mutual fund"],
    correct: 0
  },
  {
    question: "What is a bull trap?",
    options: ["A false signal indicating that a declining trend in a stock or index has reversed and is heading upwards", "A type of bond", "A financial statement", "A type of mutual fund"],
    correct: 0
  },
  {
    question: "What is a bear trap?",
    options: ["A false signal indicating that a rising trend in a stock or index has reversed and is heading downwards", "A type of bond", "A financial statement", "A type of mutual fund"],
    correct: 0
  },
  {
    question: "What is a penny stock?",
    options: ["A stock that trades for less than $5 per share", "A type of bond", "A financial statement", "A type of mutual fund"],
    correct: 0
  }
];
export default function Simulation() {
  const [portfolio, setPortfolio] = useState({
    cash: 100000,
    stocks: Object.keys(STOCKS).reduce((acc, stock) => ({...acc, [stock]: { quantity: 0, avgPrice: 0 }}), {})
  });
  ...
  const handleTrade = (action) => {
    ...
    if (action === 'buy') {
      ...
      setPortfolio(prev => {
        ...
        const newTotalCost = (prev.stocks[selectedStock].quantity || 0) * (prev.stocks[selectedStock].avgPrice || 0) + amount * currentPrice;
