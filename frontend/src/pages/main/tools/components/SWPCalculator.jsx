...
const SWPCalculator = () => {
  ...
  return (
    <div className="bg-[#ffffff] py-6 sm:py-12 px-4 sm:px-6 lg:px-8 font-sans relative overflow-hidden min-h-screen">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          <div className="p-4 sm:p-6 relative">
            <h3 className="text-xl sm:text-2xl font-black tracking-tight uppercase mb-3 sm:mb-4 text-center">Systematic Withdrawal Plan Calculator</h3>
            ...
            <div className="page-container">
              ...
              <div className="flex items-center justify-center mb-4 sm:mb-6">
                <label className="text-black font-black tracking-wide uppercase text-xs sm:text-sm mr-3 sm:mr-4">Currency:</label>
                <select
                  className="form-select bg-white/80 backdrop-blur-sm border-2 border-black/20 text-black rounded-lg sm:rounded-xl p-2 focus:ring-2 focus:ring-black/30 focus:border-black/40 font-bold text-sm sm:text-base"
              ...
              <div className="input-container space-y-3 sm:space-y-4">
                <div>
                  <label htmlFor='investment2' className="block text-black font-black mb-2 tracking-wide uppercase text-xs sm:text-sm">Total Investment:</label>
                  <input
                    type="number"
                    value={totalInvestment}
                    id='investment2'
                    onChange={(e) => setTotalInvestment(e.target.value)}
                    className="form-input block w-full bg-white/80 backdrop-blur-sm border-2 border-black/20 text-black rounded-lg sm:rounded-xl p-3 focus:ring-2 focus:ring-black/30 focus:border-black/40 placeholder-black/60 font-bold text-sm sm:text-base"
                    placeholder="Enter total investment amount"
                    required
                  />
                </div>
                <div>
                  <label htmlFor='withdraw' className="block text-black font-black mb-2 tracking-wide uppercase text-xs sm:text-sm">Withdrawal Per Month:</label>
                  <input
                    type="number"
                ...
                <div>
                  <label htmlFor='return2' className="block text-black font-black mb-2 tracking-wide uppercase text-xs sm:text-sm">Expected Return Rate (%):</label>
                  <input
                    type="number"
                ...
                <div>
                  <label htmlFor='period' className="block text-black font-black mb-2 tracking-wide uppercase text-xs sm:text-sm">Total Period (Years):</label>
                  <input
                    type="number"
                    value={totalPeriod}
                    id='period'
                  ...
                  <div className="text-black font-bold">
                    ...
                    {remainingAmount && !error && (
                      <div className="text-base sm:text-lg flex flex-col sm:flex-row sm:items-center">
                        ...
                        <span className="text-xl sm:text-2xl font-black sm:ml-2">{currency}{parseFloat(remainingAmount).toLocaleString()}</span>
                      </div>
                    )}
                  </div>
                )}
